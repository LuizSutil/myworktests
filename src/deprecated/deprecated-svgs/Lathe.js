...
export default function Lathe(props) {
  return (
    <svg version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 469.122 469.122" style={{enableBackground: 'new 0 0 469.122 469.122'}} xmlSpace="preserve" width= {props.width?props.width : "245px" } height={props.height? props.height : "300px"} {...props}>
      <g>
